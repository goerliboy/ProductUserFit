      ...
      <div className="max-w-4xl w-full space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 px-6 py-2 rounded-lg bg-purple-500 dark:bg-purple-500/40 hover:bg-purple-400 dark:hover:bg-purple-400/50 text-gray-100 dark:text-gray-100 transition-colors font-medium"
          >
