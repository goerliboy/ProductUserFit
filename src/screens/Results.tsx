      ...
      <div className="max-w-4xl w-full space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 px-6 py-2 rounded-lg bg-blue-300 dark:bg-blue-600/40 hover:bg-blue-500 dark:hover:bg-blue-500/50 text-gray-100 dark:text-gray-200 transition-colors font-medium"
          >
